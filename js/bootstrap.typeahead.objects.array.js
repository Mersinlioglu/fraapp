 ...
 * https://gist.github.com/justthefish/3636051
 */
  ...
  * ================================= */
  ...
  var Typeahead = function (element, options) {
    ...
    this.$hiddeninput = $('<input type="hidden" name="'
            +this.$element.attr('name')+'-data-id" id="'+this.$element.attr('id')+'-hidden" value="">').insertAfter(this.$element)
  ...
  , select: function () {
      ...
      this.$hiddeninput
        .val(this.updater(id))
        .change()
      this.$element.css('background-color','rgb(241, 255, 228)');
